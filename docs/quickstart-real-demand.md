...
```powershell
powershell -ExecutionPolicy Bypass -File scripts/validate-reverse-eng-staleness.ps1 -ReverseEngPath .alfred-docs-app/<id-iniciativa>/<id-demanda>/01-inception/002-reverse-eng.md -AppRepoPath .
```
...
```powershell
powershell -ExecutionPolicy Bypass -File scripts/validate-sdd-gate.ps1 -HubDemandPath <alfred-docs-hub>/<id-iniciativa>/<id-demanda>
```
...
```powershell
powershell -ExecutionPolicy Bypass -File scripts/validate-demand.ps1 -HubDemandPath <alfred-docs-hub>/<id-iniciativa>/<id-demanda>
```
