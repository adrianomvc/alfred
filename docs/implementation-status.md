...
- **Measurement:** D10/D32 cost and baselines; D43 append-only usage/cost/artifact logs, raw Claude Code hook support, host-agnostic observability domain/ports, usage summary for toolbar presentation, decision rollups, insights, and D46 model policy with automated validation.
