...
- `alfred-docs-hub/005-memory.md` + `alfred-docs-hub/memory/` — cross-demand memory, generated by `scripts/workflow/generate-memory-index.py` as observations accrue (`rules/common/memory-policy.md`); empty until the first demand distils one.
