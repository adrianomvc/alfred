...
- [ ] W6.2 `normalize-usage-cost` com export real do host. Desenho aprovado em `docs/usage-cost-adoption.md`: caminho primario DEVIN/Devin export ou billing corporativo; caminho secundario `ccusage` para CLIs locais suportadas; correlacao por `ALFRED_RUN_ID`, repo, branch, commit e janela de tempo; sem custo inventado.
