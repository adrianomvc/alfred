...
## Supreme law
Never invent. On any doubt, stop and ask. Ground before asserting. Human is in control.

## Status
Skeleton (stubs). Conceptual design lives in the plan file `prompt-para-claude-ticklish-lemur.md`.
