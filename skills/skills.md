...
|---|---|---|---|
| `ai-stack-finder` | [skills/ai-stack-finder/SKILL.md](skills/ai-stack-finder/SKILL.md) | Load after the mandatory capability checkpoint finds an uncovered capability and external discovery is required — for any topic; AI Stack is first in the order defined in `knowledge/external-catalogs.md` and degrades to the next catalog. Also load when the human asks to search or refresh the AI Stack marketplace/catalog. | process, degradation, review checklist |
